...
namespace MVCWebApplication.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public StudentsController(MVCWebApplicationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Student != null ? 
                          ...
                          Problem("Entity set 'MVCWebApplicationContext.Student'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("RollNo,Name,Address")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RollNo,Name,Address")] Student student)
        {
